  ...
  const testimonials = [
    {
      ...
      photo: '👩‍💼',
      text: 'Запустила интернет-магазин за 2 дня. Продажи выросли на 300% за месяц!',
      rating: 5
    },
    {
      name: 'Дмитрий Козлов',
      role: 'Фрилансер',
      photo: '👨‍💻',
      text: 'Нашел здесь 15 заказов за первый месяц. Платформа сама ищет клиентов!',
      rating: 5
    },
    {
      name: 'Елена Волкова',
      ...
      photo: '👩‍🏫',
      text: 'Создаю и продаю курсы. Заработала первый миллион за 3 месяца.',
      rating: 5
    }
  ];
